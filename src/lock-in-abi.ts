...
export type PactTuple = readonly [
  ...
  missionType: number,
  missionKey: Hash,
  missionConfigHash: Hash,
  remainingPool: bigint,
  finalized: boolean,
  cancelled: boolean,
];

export const MONAD_CHECK_IN_MISSION = 1;
...
export const lockInAbi = [
  { type: "function", name: "nextPactId", stateMutability: "view", inputs: [], outputs: [{ name: "", type: "uint256" }] },
  {
    ...
    outputs: [
      ...
      { name: "missionKey", type: "bytes32" },
      { name: "missionConfigHash", type: "bytes32" },
  ...
  { type: "function", name: "joinPact", stateMutability: "nonpayable", inputs: [{ name: "pactId", type: "uint256" }], outputs: [] },
  { type: "function", name: "checkIn", stateMutability: "nonpayable", inputs: [{ name: "pactId", type: "uint256" }, { name: "dayIndex", type: "uint8" }], outputs: [{ name: "eventNullifier", type: "bytes32" }] },
  ...
  ...[
    ...
    "UnsupportedMission", "PactNotFound", "CreationIsPaused", "JoiningIsPaused", "CheckInsArePaused",
    "JoinClosed", "AlreadyJoined", "PactFull", "NotParticipant", "InvalidDay", "CheckInOutsideDay",
    "DayAlreadyCompleted", "TargetAlreadyMet", "UnderfilledPact", "SubmissionClosed", "EventAlreadyUsed",
    "NotCreator", "CancellationClosed", "AlreadyCancelled", "FinalizationTooEarly", "AlreadyFinalized",
    "NotFinalized", "NotEligible", "AlreadyClaimed",
  ].map((name) => ({ type: "error" as const, name, inputs: [] })),
  {
    ...
    inputs: [
      ...
      { indexed: true, name: "missionType", type: "uint8" },
      ...
      { indexed: false, name: "missionKey", type: "bytes32" },
      { indexed: false, name: "missionConfigHash", type: "bytes32" },
    ],
  },
  ...
  { type: "event", name: "CheckedIn", anonymous: false, inputs: [{ indexed: true, name: "pactId", type: "uint256" }, { indexed: true, name: "account", type: "address" }, { indexed: true, name: "dayIndex", type: "uint8" }, { indexed: false, name: "eventNullifier", type: "bytes32" }, { indexed: false, name: "occurredAt", type: "uint64" }] },
