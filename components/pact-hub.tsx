    ...
    return (
      <section className="pact-hub" id="play" aria-labelledby="pact-hub-title">
        <header className="hub-heading">
          <div><span className="eyebrow">New-stake protection</span><h2 id="pact-hub-title">{unavailable ? "Access unavailable" : health.checked ? "New locks are closed" : "Checking access"}</h2></div>
