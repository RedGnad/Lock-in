export default function PrivacyPage() {
  ...
  return (
    <main className="legal-page">
      ...
      <section><h2>Ce que Lock In traite</h2><p>Ton adresse de wallet, le pacte, le challenge, l’identifiant de session Reclaim et les champs Strava nécessaires : compte athlète, activité, titre, sport, heure, distance, présence GPS et statut trainer.</p></section>
