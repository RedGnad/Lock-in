export default function PrivacyPage() {
  ...
  return (
    <main className="legal-page">
      ...
      <section><h2>Website and wallet</h2><p>The app reads the public address of the wallet you connect and public Monad state to display pacts and prepare transactions. Hosting and RPC providers may process technical data such as IP address, device, request time, and logs under their own policies.</p></section>
