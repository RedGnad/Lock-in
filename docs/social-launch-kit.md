...
- Cooperation: invite friends, watch the crew progress, and help each other keep showing up.
- PvP: finishers split the pool when others do not finish.
- Fair fallback: if nobody finishes, every participant is eligible for a refund.

### Core promise

> Put a small stake behind the promise you keep making to yourself.

### Recommended landing message

**Eyebrow:** COMPETITIVE ACCOUNTABILITY
...
- Short, direct, competitive, and energetic.
...
- **Root for the crew. Race the quit line.**
- **A streak your friends can see—and your wallet can feel.**

### “Funded by quitters” lines

These are campaign shorthand. Use them only when the destination or nearby copy explains that finishers split non-finishers’ stakes and that zero finishers are refunded.

- **Finishers split the pool funded by those who quit.**
- **Built by the crew. Funded by quitters.**
- **Keep showing up. Let quitters fund the finishers.**
- **The crew brings the pressure. Quitters bring the upside.**
...
- “Cheat-proof,” “fraud-proof,” or “impossible to fake.”
...
> 1. Pick a mission and duration
> 2. Invite your crew
> 3. Everyone stakes the same amount—up to 1 USDC
> 4. Complete enough days
> 5. Finishers split the pool

### Post 3 — cooperation plus PvP

> The crew helps you show up. The pool makes quitting cost something.
>
> If everyone finishes, everyone gets their stake back. If some quit, finishers split the full pool. If nobody finishes, everyone is refunded.
...
### Optional independence reply

> Lock In is independent from Strava, Duolingo, Reclaim, Monad, Circle, wallets, RPC providers, and explorers. Their names identify external services or infrastructure only; no partnership, sponsorship, approval, or endorsement is claimed.
...
### Builder-oriented cast

> We built the streak app we wanted our group chat to have:
>
> pick a mission → invite friends → equal stake → prove each day → settle the pool
>
...
- Time zone
- Mission preference: running / learning
...
Do not request private keys, seed phrases, Strava credentials, Duolingo credentials, cookies, or Reclaim session secrets.
...
|---|---|---|---|
| T−3 | Create curiosity | “Solo streaks are easy to ignore.” teaser | Collect interest from 3–5 reliable crews directly |
| T−2 | Explain the category | Accountability + PvP/cooperation explainer | Publish rules and proof-boundary page |
| T−1 | Set expectations | Tester CTA and 0.1 USDC recommendation | Confirm support coverage and incident contacts |
...
- One founder response thread answering genuine tester objections.

Do not manufacture daily volume. A small real cohort is stronger than repetitive engagement bait.

## Asset checklist

### Required launch assets

- [ ] 30-second captioned product demo in 16:9 and vertical formats.
...
- [ ] Accessible alt text and burned-in captions.
...
- [ ] Six-second hook loop: create → invite → pool.
- [ ] Simple settlement diagram: all finish / some finish / none finish.
- [ ] Founder face-to-camera explanation of why the stake is capped.
- [ ] Short screen recording of a successful refund path—not only a winner path.
- [ ] Public changelog for issues found by the first cohort.

## Honest proof and security wording
...
> For the current missions, Lock In uses Reclaim zkTLS attestations to check what Strava or Duolingo returned over HTTPS, then applies mission-specific rules. A qualifying record is evidence that the service returned those fields. It is not proof of biological movement, comprehension, human authorship, or exclusive account control. GPS spoofing, imported data, account sharing, bots, modified devices, external help, and upstream errors remain possible.
...
> Lock In is an independent product. Strava and Duolingo provide user-facing services whose records may be used in mission proofs; Reclaim provides proof technology; Monad provides blockchain infrastructure. Naming any of them describes functionality only and does not claim partnership, sponsorship, approval, or endorsement.
...
- The link opens the intended production deployment, not preview or staging.
- The post contains no partnership claim and no stronger proof claim than the product can support.
