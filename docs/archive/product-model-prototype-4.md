# Historical prototype 4 product and proof-boundary model

> Archived development history. This is not a product release, current specification, or launch plan. See [`../product-model.md`](../product-model.md) for the current unreleased specification.
