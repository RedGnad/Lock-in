# Historical Strava V3 security model

> Retired on 15 July 2026. This document describes the V3 Reclaim experiment only. It is not the active Lock In mission or release security model. See the root `SECURITY.md` for V4.
